...
import {
  ...
  Palette, Smartphone, Tv, Laptop, Cast, Satellite, Database,
  ...
  Activity, MapPin, Smartphone as PhoneIcon, Tablet, Monitor,
  Headphones, Speaker, Airplay, Chromecast, Rss, Antenna,
  Crosshair, Target, Award, Gem, Wallet, Receipt, Percent,
  CircleDollarSign, CreditCard, Banknote, PiggyBank, Landmark,
  Briefcase, Building2, Store, Factory, Warehouse, Truck, Package,
  Boxes, Container, Server, Network, CircuitBoard, Cpu, HardDrive as DiskIcon,
  CloudCog, CloudLightning, CloudRain, CloudSun, Moon, Sun,
  Thermometer, Wind, Droplets, Snowflake, Flame, Tornado, Earthquake,
  Waves, Anchor, Compass, Navigation, MapPin as PinIcon, Locate,
  Map as MapIcon, Globe as WorldIcon, Plane, Rocket, Orbit, Atom,
  Dna, Microscope, Telescope, SatelliteDish, Radar, Scan, ScanLine,
  ScanFace, Fingerprint, BadgeCheck, ShieldCheck, ShieldAlert,
  ShieldQuestion, ShieldOff, Lock as LockIcon, Unlock, KeyRound,
  KeySquare, Passcode, Password, Pass, Ticket as TicketIcon, TicketCheck,
  Vibrate, VibrateOff, Bell, BellRing, BellOff, BellDot,
  Mail, Inbox, Send, MessageSquare, MessageCircle, MessagesSquare,
  Phone, PhoneCall, PhoneOff, PhoneForwarded, PhoneIncoming,
  PhoneOutgoing, PhoneMissed, Voicemail, Megaphone, MegaphoneOff,
  Flag, FlagTriangle, FlagOff, BookOpen, Book, BookMarked, Library,
  GraduationCap, School, University, Trophy as TrophyIcon, Medal,
  Award as AwardIcon, Crown as CrownIcon, Gem as GemIcon, Diamond,
  Ruby, Sapphire, Emerald, Pearl, Opal, Jade, Amber, Coral,
  Shell as ShellIcon, Star as StarIcon, Heart, ThumbsUp, ThumbsDown,
  Smile, Frown, Meh, Laugh, Angry, Annoyed, AnnoyedOff,
  AlertCircle, AlertTriangle, AlertOctagon, Info, HelpCircle,
  HelpOctagon, QuestionMark, XCircle, XOctagon, CheckOctagon,
  CheckSquare, Check as CheckIcon, MinusCircle, MinusSquare,
  PlusCircle, PlusSquare, Divide, Equal, NotEqual, Infinity,
  Percent as PercentIcon, Hash, At, Link, LinkOff, ExternalLink,
  Share2, Share, Upload as UploadIcon, Download as DownloadIcon,
  CloudUpload, CloudDownload, CloudOff, CloudSnow, CloudFog,
  CloudHail, CloudMoon, CloudSunRain, CloudLightning as StormIcon,
  ThermometerSun, ThermometerSnowflake, SunDim, SunMedium, SunMoon,
  Sunrise, Sunset, Moon as MoonIcon, MoonStar, StarHalf,
  StarOff, Stars, Sparkles as SparkleIcon, Wand2, Wand,
  Paintbrush, PaintBucket, Eraser, Pencil, PenTool, Highlighter,
  StickyNote, Clipboard, ClipboardCheck, ClipboardCopy, ClipboardList,
  ClipboardPaste, ClipboardPen, ClipboardType, ClipboardX,
  File, FilePlus, FileMinus, FileCheck, FileX, FileQuestion,
  FileWarning, FileCode, FileJson, FileType, FileSpreadsheet,
  FilePieChart, FileBarChart, FileLineChart, FileAudio as AudioFile,
  FileImage as ImageFile, FileVideo as VideoFile, FileText as TextFile,
  FileArchive, FileClock, FileCog, FileHeart, FileKey,
  FileLock, FileScan, FileSearch, FileSignature, FileSymlink,
  FileTerminal, FileUp, FileDown, FileCode2, FileDigit,
  Folder as FolderIcon, FolderOpen, FolderPlus, FolderMinus,
  FolderCheck, FolderX, FolderSync, FolderGit, FolderGit2,
  FolderKanban, FolderArchive, FolderClock, FolderCog, FolderDown,
  FolderEdit, FolderHeart, FolderKey, FolderLock, FolderSearch,
  FolderSymlink, FolderTree, FolderUp, FolderX as FolderClose,
  Briefcase as BriefIcon, Building, Building2 as BuildingTwo,
  Home, HomeIcon, House, Warehouse as StoreIcon, Store as ShopIcon,
  Factory as PlantIcon, Hospital, Church, Castle as CastleIcon,
  School2, Hotel, Bank, Landmark as Monument, TreePine, TreeDeciduous,
  Flower, Flower2, Sprout, Leaf, LeafyGreen, Clover, Cherry,
  Apple, Citrus, Grape, Banana, Carrot, Cookie, Croissant,
  Cupcake, Donut, IceCream, IceCream2, Lollipop, Candy,
  CandyOff, Beef, Fish, Ham, Pizza, Sandwich, Soup,
  Egg, EggFried, Milk, Coffee, Tea, Wine, Beer, Cocktail,
  GlassWater, Utensils, ForkKnife, Knife, Spoon, CookingPot,
  Microwave, Refrigerator, WashingMachine, Heater, Fan,
  AirVent, Lamp, LampCeiling, LampDesk, LampFloor, LampWall,
  Lightbulb, LightbulbOff, Flashlight, Candle, FireExtinguisher,
  Plug, PlugZap, Battery, BatteryCharging, BatteryFull,
  BatteryLow, BatteryMedium, BatteryWarning, Power, PowerOff,
  PowerCircle, Signal, SignalHigh, SignalLow, SignalMedium,
  WifiOff, Bluetooth, BluetoothOff, BluetoothConnected,
  Usb, Battery as BatteryIcon, BatteryCharging as ChargingIcon,
  BatteryFull as FullIcon, BatteryLow as LowIcon, BatteryMedium as MedIcon,
  BatteryWarning as WarnIcon, Plug as PlugIcon, PlugZap as ZapPlug,
  Cable, CircuitBoard as CircuitIcon, Cpu as CpuIcon, Database as DbIcon,
  Disc as DiscIcon, Disc3, DiscAlbum, FileMusic, HardDrive as HddIcon,
  Keyboard, Laptop as LaptopIcon, Laptop2, Monitor as MonitorIcon,
  MonitorSmartphone, MonitorSpeaker, MonitorStop, MonitorPlay as MonPlay,
  MonitorX, Mouse, MousePointer, MousePointer2, MousePointerClick,
  PcCase, Printer, PrinterCheck, Router, Scan as ScanIcon,
  ScanFace as FaceScan, ScanLine as LineScan, ScanSearch as SearchScan,
  Smartphone as PhoneDevice, SmartphoneCharging, SmartphoneNfc,
  SmartphoneOff, Speaker as SpeakerIcon, SpeakerOff, SpeakerVolume,
  Tablet as TabletIcon, TabletSmartphone, Tv as TvIcon, Tv2,
  Watch, WatchIcon, Webcam, WebcamOff,
  Braces, Brackets, Code, Code2, Codepen,
  Codesandbox, Command as CmdIcon, CurlyBraces, FileCode as CodeFile,
  FileJson as JsonFile, FileType as TypeFile, FileTerminal as TermFile,
  Hash as HashIcon, Hexagon, Infinity as InfIcon, NotepadText,
  Parentheses, Pi, Quote, Regex, Sigma, Slash, SquareBrackets,
  Terminal, TerminalSquare, Type, Variable, Bug as BugIcon,
  BugOff, BugPlay, Footprints, Search as SearchIcon, SearchCheck,
  SearchCode, SearchSlash, SearchX, ZoomIn, ZoomOut, Aperture,
  Focus, Eye as EyeIcon, EyeOff, Glasses, GlassesOff, Contact,
  Contact2, FlameKindling, Flame as FireIcon, FlameOff, Cherry as FruitIcon,
  Citrus as CitrusIcon, Grape as GrapeIcon, IceCream as IceIcon,
  IceCream2 as Ice2Icon
} from 'lucide-react';
