/* ═══════════════════════════════════════════════════════════
   Bot Builder — AI-powered bot creation
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { Zap, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'Bot Builder Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'Bot Builder Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'Bot Builder Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'Bot Builder Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamBot() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#6B7280]">AI-powered bot creation · Collective General Technologies, LLC</p>
              </div>
            </div>
