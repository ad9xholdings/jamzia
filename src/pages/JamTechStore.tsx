/* ═══════════════════════════════════════════════════════════
   JamTechStore — Technology store
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { Smartphone, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamTechStore Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamTechStore Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamTechStore Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamTechStore Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamTechStore() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#7096D1]/10 flex items-center justify-center">
                <Smartphone size={20} className="text-[#7096D1]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamTechStore</h1>
                <p className="text-[10px] text-[#6B7280]">Technology store · Collective General Technologies, LLC</p>
              </div>
            </div>
