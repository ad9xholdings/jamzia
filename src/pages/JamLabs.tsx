/* ═══════════════════════════════════════════════════════════
   JamLabs — Virtual labs & experiments
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { FlaskConical, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamLabs Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamLabs Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamLabs Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamLabs Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamLabs() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#7096D1]/10 flex items-center justify-center">
                <FlaskConical size={20} className="text-[#7096D1]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamLabs</h1>
                <p className="text-[10px] text-[#6B7280]">Virtual labs & experiments · Collective General Technologies, LLC</p>
              </div>
            </div>
