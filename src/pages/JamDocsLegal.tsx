/* ═══════════════════════════════════════════════════════════
   JamDocsLegal — Legal document hub
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { ScrollText, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamDocsLegal Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamDocsLegal Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamDocsLegal Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamDocsLegal Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamDocsLegal() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#7096D1]/10 flex items-center justify-center">
                <ScrollText size={20} className="text-[#7096D1]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamDocsLegal</h1>
                <p className="text-[10px] text-[#6B7280]">Legal document hub · Collective General Technologies, LLC</p>
              </div>
            </div>
