/* ═══════════════════════════════════════════════════════════
   JamForm — Form builder
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { Type, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamForm Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamForm Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamForm Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamForm Item Delta', status: 'archived', updated: '1 day ago' },
];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#22c55e]/10 flex items-center justify-center">
                <Type size={20} className="text-[#22c55e]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamForm</h1>
                <p className="text-[10px] text-[#6B7280]">Form builder · Collective General Technologies, LLC</p>
              </div>
            </div>
