...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamBeats Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamBeats Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamBeats Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamBeats Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamBeats() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#ec4899]/10 flex items-center justify-center">
                <Music size={20} className="text-[#ec4899]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamBeats</h1>
                <p className="text-[10px] text-[#6B7280]">Beat marketplace · Collective General Technologies, LLC</p>
              </div>
            </div>
