...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamTickets Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamTickets Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamTickets Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamTickets Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamTickets() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#f59e0b]/10 flex items-center justify-center">
                <Ticket size={20} className="text-[#f59e0b]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamTickets</h1>
                <p className="text-[10px] text-[#6B7280]">Event ticketing · Collective General Technologies, LLC</p>
              </div>
            </div>
