/* ═══════════════════════════════════════════════════════════
   JamSwap — Token swap engine
   Built by Collective General Technologies, LLC
   ═══════════════════════════════════════════════════════════ */

import { useState } from 'react';
import { ArrowDownUp, Plus, Search, ChevronRight } from 'lucide-react';;
...
const INITIAL_ITEMS: Item[] = [
  { id: '1', name: 'JamSwap Item Alpha', status: 'active', updated: '2 min ago' },
  { id: '2', name: 'JamSwap Item Beta', status: 'pending', updated: '1 hr ago' },
  { id: '3', name: 'JamSwap Item Gamma', status: 'active', updated: '3 hr ago' },
  { id: '4', name: 'JamSwap Item Delta', status: 'archived', updated: '1 day ago' },
];

export default function JamSwap() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#22c55e]/10 flex items-center justify-center">
                <ArrowDownUp size={20} className="text-[#22c55e]" />
              </div>
              <div>
                <h1 className="text-lg font-bold">JamSwap</h1>
                <p className="text-[10px] text-[#6B7280]">Token swap engine · Collective General Technologies, LLC</p>
              </div>
            </div>
